...
| **Told when somebody leaves early** | A session that ends without the exam's exit code, or stops checking in while live, raises a "Needs a look" row and a desktop notification |
